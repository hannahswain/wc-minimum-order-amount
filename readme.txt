...
This plugin adds the option for a minimum order amount, as well as the options to separately change the notification texts for the cart and checkout pages
